...
const panelDictionaryResult = document.getElementById('panel-dictionary-result'); //词典结果
const panelTampermonkeyResult = document.getElementById('panel-tampermonkey-result'); //油猴脚本结果
